(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        var $spanMyName = '<span id= "my-name">제 이름은 조예슬입니다.</span>';
        $('#hello').prepend($spanMyName);
        // console.log($('hello').prepend($spanMyName));
        ...
        */
        //Answer 10.
        var buttonBtn1 = $('button.btn-1');
        var divBox1 = $('div.box-1');
        var width = 100;
        var _true = true;

    //     buttonBtn1.click( function(){
    //         if(_true){
    //             width += 100;
    //             divBox1.width(width);
    //             if(width == 500){
