(function($){
    $(document).ready(function(){
        ...
        */
        ...
        var $spanEl = '<span>제 이름은 이명빈 입니다. </span>';
        var $divHello = $('div#hello');
        $divHello.prepend($spanEl);
        // $('<span>제 이름은 이명빈 입니다. </span>').prependTo($divHello);
        ...
        */
        ...
        for(var i = 0; i < images.length; i++){
            divBI += '<div class="banner-item"></div>'
        }
        console.log(divBI);
        $('div.banner-container').html(divBI);
        for(var i = 0; i < images.length; i++){
        ...
        */
        ...
        var $pMoveTop = $('p.move-top');
        $('body').prepend($pMoveTop);
        $pMoveTop.addClass('move').html('위로 이동했습니다.');
        ...
        */
        ...
        var $pMoveBt = $('p.move-bottom');
        $('body').append($pMoveBt);
        $pMoveBt.addClass('move').html('아래로 이동했습니다.');
        // console.log($pMoveBt);
        ...
        */
        ...
        $('p.error').remove(); // 요소 전체 삭제
        // $('p.error').empty(); // 요소의 내용만 삭제
