(function($){
    $(document).ready(function(){
        ...
        */
        ...
        $('div').eq(0).append("<span id = 'my-name'>제 이름은 최상욱 입니다.</span>");
        ...
        */
        ...
        // for(var i = 0; i > 4; i++)
        // {
        //     $('.list-1 li').after().clone('li');
        // }
        //var $li1 = $('.list-1 li').clone();
        //$('body').append($p);
        for(var i = 2; i < 5; i++){
