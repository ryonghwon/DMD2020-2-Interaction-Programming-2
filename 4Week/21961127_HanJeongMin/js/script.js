(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        $('div').eq(0).append('<span>제 이름은 한정민입니다.</span>');
        ...
        */
        ...
        for(var i=0; i < add.length; i++){
            ...
            /* $('.banner-item').addClass('<img src="' + i + '" >'); */
            $('.banner-item').addClass('<img src="' + images[i] + '" >');
        }
        //Quest 3.
        /*
        ...
        */
        //Answer 3.
        $topMove = $('p.move-top');
        $('body').prepend($topMove);
        $topMove.addClass('move').html('위로 이동했습니다.');
        ...
        */
        //Answer 4.
        /* $('body').append($('p.move-bottom')).addClass('move').html('아래로 이동했습니다'); */
        $bottomMove = $('p.move-bottom');
        $('body').append($bottomMove);
        $bottomMove.addClass('move').html('아래로 이동했습니다.');
        ...
        */
        ...
        /* var $listNum = '' */
        //for(var i = 2; i <= 5; i++) {
            //var $listNum = "<li>리스트 " + i + "</li>";
            /* $('ul.list-1').prepend($listNum).eq(0); */
            //$('ul.list-1').prepend($listNum);
        //}
        /* $('ul.list-1').append($listNum); */
        for(var i = 2; i < 5; i++) {
            var $listNum = "<li>리스트 " + i + "</li>";
            $('ul.list-1').append($listNum);
        }
        ...
        */
        ...
        for(var i = 1; i < 5; i++) {
            var $listNum = "<li>리스트 " + i + "</li>";
            /* $('ul.list-2').eq(0).append($listNum); */
            $('ul.list-2').eq(0).prepend($listNum);
        }
