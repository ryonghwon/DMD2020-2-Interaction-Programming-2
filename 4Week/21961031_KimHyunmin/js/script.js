(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        var $span = $("<span id='my-name'>'제 이름은 김현민입니다.'</span>"); 
        $("#hello").prepend($span);
        // console.log($("#hello").prepend($span));
        ...
        */
        ...
        for (var i = 0; i < images.length; i++) {
            $divBanner += "<div class='banner-item'></div>";
            $("div.banner-container").html($divBanner);
        }
        ...
        */
        ...
        var $mTop = $("p.move-top");
            $body = $("body");
        $body.prepend($mTop);
        $mTop.addClass("move").html("위로 이동했습니다.");
        ...
        */
        //Answer 4.
        var $mBottom = $("p.move-bottom");
        $body.append($mBottom);
        $mBottom.addClass("move").html("아래로 이동했습니다.");
