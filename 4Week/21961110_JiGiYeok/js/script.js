(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        var $spanEl = "<span id='my-name'>제 이름은 지기역입니다.</span>";
        var $divHello = $('div#hello');
        $divHello.eq(0).prepend($spanEl);
        ...
        */
        ...
        console.log($('div.banner-container'));
        ...
        */
        //Answer 4.
        $pMoveBottom = $('p.move-bottom');
        $('body').append($pMoveBottom);
        $pMoveBottom.addClass('move').html('아래로 이동했습니다.');
        ...
        */
        //Answer 9.
        var $ulLi02 = $('ul.list-2').eq(0);
        var liEls2 = "";
        for(var i = 1; i< 5;i++){
            liEls2 += "<li>" + "리스트" + i + "</li>";
        }
        $ulLi02.before(liEls2);
