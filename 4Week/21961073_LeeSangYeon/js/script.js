(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        var $spanMyName = "<span id='MyName'>제 이름은 이상연입니다.</span>";
        var $divHello = $('div#hello');;
        console.log($spanMyName);
        console.log($divHello);
        $divHello.prepend($spanMyName);
        ...
        */
        ...
        for(var i = 0; i < images.length; i++){
            for(var i = 0; i < images.length; i++){
                divBitem += '<div class="banner-item"></div>';
            }
            $('div.banner-container').html(divBitem);
            for(var i = 0; i <images.length; i++){
        ...
        */
        //Answer 9.
        var $ul2List = $('ul.list-2').eq(0);
        var list2 = "";
        for(var i = 1; i< 5; i++){
            list2 += "<li>" + "리스트" + i + "</li>";
        }
        $ul1List.before(list2);
