(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        $("div#hello").prepend("<span id = 'my-name'>제 이름은 송재혁 입니다.</span>");
        ...
        */
        ...
        for(var i = 0 ; i < images.length ; i++){
            var $divItem = "<div class = 'banner-item'></div>";
            $("div.banner-container").append($divItem);
            var $itemImg = "<img src =" + images[i] + ">";
            $("div.banner-item").eq(i).append($itemImg);
        }
        ...
        */
        //Answer 8.
        for(var i = 2 ; i < 5 ; i++){
            var $liList = "<li>리스트 " + i + "</li>";
            $("ul.list-1").append($liList);
        }
        ...
        */
        //Answer 9.
        for(var i = 4 ; i > 0 ; i--){
            var $liList2 = "<li>리스트 " + i + "</li>" ;
            $("ul.list-2").prepend($liList2);
        }
