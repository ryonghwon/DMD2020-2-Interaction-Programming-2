(function($){
    $(document).ready(function(){
        ...
        */
        ...
        $divHello.append("<span>제 이름은 남정아입니다</span>");
        $('span').eq(0).attr('id','my-name');
        ...
        */
        ...
        for(var i=0; i < max; i++){
            $('div.banner-container').append("<div class = 'banner-item'>test "+i+"</div>");
        }
        ...
        */
        ...
        $pMovedTop = $('p.move-top').prependTo($('body')).addClass("move");
        $pMovedTop.text("위로 이동했습니다");
        ...
        */
        ...
        $('p.error').remove();
        //$('p.error').detach();
        //$('p.error').html(''); // => <p>태그는 그대로 남아있음
        //$('p.error').empty(); // => <p>태그는 그대로 남아있음
        ...
        */
        ...
        $('p.modify').empty(); //내용 비우기
        $('p.modify').remove(); //문서 삭제하기
        ...
        */
        ...
        $ulList1 = $('ul.list-1').children().length;
        
        for(var i=2; i < $ulList1 + 4; i++){
