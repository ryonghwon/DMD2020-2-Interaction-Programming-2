...
*/
// Answer 4.
var orders = { name : ["이수아"], coffee : ["아메리카노", "에스프레소", "카페라떼"] };
...
// Answer 5.
var profile = {
    intro : ["안녕하세요", "저는", "입니다.", "잘부탁드립니다."],
    name : "이수아",
    age : 22,
    school : "계원예술대학교",
    major : "디지털 미디어 디자인과",
    favorite : ["그림그리기", "독서", "게임"]
};
var fav = "";
for(var i = 0; i < profile.favorite.length; i++){
    fav = profile.favorite.join();
}
// console.log(fav);
console.log(profile.intro[0] + ", " + profile.intro[1] + profile.name + profile.intro[2] +
 " " +   profile.age + "살이며 " + profile.school + profile.major + "를 다니고 있습니다. 제 취미는 " + fav + profile.intro[2]);