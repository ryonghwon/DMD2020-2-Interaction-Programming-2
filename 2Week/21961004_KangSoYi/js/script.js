...
var info = {
    name : "강소이",
    age : 24,
    hobby : ["노래 듣기", " 영화 감상", " 독서"],
    love : ["고양이", " 겨울", " 낮잠"]
};

var basic = "안녕하세요. 저는 " +info.age + "살 " + info.name + "입니다. " + "저의 취미는 " + info.hobby + "입니다.";

for (var love in info ) {
    var loveThings = "제가 좋아하는 것은 " + info[love] + "입니다.";
}

function introduction() {
    console.log(basic);
    console.log(loveThings);
}
