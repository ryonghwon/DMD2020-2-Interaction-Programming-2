...
(function($){
    $(document).ready(function() {
        ...
        function reset() {
            ...
            var $text = _this.$horizontal.find('.text-area');
        ...
        function stickyScroll() {
            var imgY = 0,
                ...
                $text = _this.$horizontal.find('.text-area'),
                $title = _this.$horizontal.find('.title'),
                $desc = _this.$horizontal.find('.desc');
            ...
            if(_scrollTop >= start) {
                ...
                if(!$text.hasClass('active')) {
                    ...
                    gsap.to($text, { y: 0, autoAlpha: 1, duration: 1 });
                    // 애니메이션이 한번만 발생.
                }
            }else{
                if(_scrollTop < start - _winH / 2) {
                    if($text.hasClass('active')){
                        ...
                        gsap.set($text, { y: 200, autoAlpha: 0 });
                    }
                }
            }
        }
