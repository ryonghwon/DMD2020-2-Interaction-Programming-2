  ...
  $(document).ready(function () {
    ...
    */
    ...
    $.ajax({
      url: './data/twice.json',
      dataType: 'json',
      success: twiceSuccess,
      error: twiceError,
    });
    function twiceSuccess(result) {
      // console.log(result);
      var items = result['response']['result']['albums'];
      // console.log(items);
      ...
      $.each(items, function (index, item) {
        // console.log(index, item);
        var name = item['albumTitle'],
          poster = item['imageUrl'],
          template = '';
        // console.log(name, poster, url);
        template += '<li class="movie-item">';
        template += '<div class="poster"><a href="#" target="_blank" title="' + name + '"><img src="' + poster + '" alt="' + name + '"></a></div>';
        template += '<div class="name"><a href="#" target="_blank" title="' + name + '">' + name + '</a></div>';
        template += '</li>';
        // console.log(template);
