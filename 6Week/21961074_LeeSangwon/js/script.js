(function($){
    $(document).ready(function(){
        ...
        */
        ...
        $bannerWrap.css({width : $bannerWidth, height : $bannerHeight});
        ...
        */
        //Answer 4.
        $bannerItem.css({float : 'left', width : $bannerWrapWidth, height : 100 +'%'});
        ...
        */
        //Answer 5. 
        // for(var i =0; i < $bannerItemLength; i++){}
        ...
        */
        ...
        function slideLeft(){
            _id--;
            $bannerContainer.css('left', _id * $bannerItem.width() * -1);
            };    
        ...
        */
        ...
        function dotSelect(){
            // $dotSpan.remove('selected');
            // for(var i = 0; i<$bannerItemLength; i++){
            //     $dotSpan.eq(i).add('.selected');
            // }
        ...
        */
        ...
        function paddleCheck(){
            ...
            }else if(_id == $bannerItemLength -1){
