(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //console.log($bannerwrapW);
        var $banneritemN = $('.banner-item').length;
        //console.log($banneritemN);
        var multiply = $bannerwrapW * $banneritemN;
        ...
        */
        ...
        $('.banner-item').css('width', $('.banner-wrap').width());
        $('.banner-item').css('height', '100%');
