(function($){
    $(document).ready(function(){
        ...
        */
        ...
        $('.banner-wrap').css('width', $bannerWidth);
        $('.banner-wrap').css('height' ,$bannerHeight);
        ...
        */
        //Answer 3.
        var $bannerWidthW = $('.banner-wrap').width();
        console.log($bannerWidthW);
        var $bannerLengthI = $('.banner-item').length;
        console.log($bannerLengthI);

        var wiWidth = $bannerWidthW * $bannerLengthI;
        console.log(wiWidth);

        $('.banner-container').width(wiWidth);
        ...
        */
        ...
        var $bannerWidthI = $('.banner-item').width();
        $bannerContainer.css('left', 0);
        console.log($bannerWidthI);
        function slideLeft(){
            _id--;
            $bannerContainer.css('left', _id*$bannerWidthI* -1);
        }
