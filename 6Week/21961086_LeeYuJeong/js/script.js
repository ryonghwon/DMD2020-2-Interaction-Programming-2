(function($){
    $(document).ready(function(){
        ...
        */
        ...
        console.log($bannerW, $bannerH); // 1000 380

        $('.banner-wrap').css('width', $bannerW);
        $('.banner-wrap').css('height', $bannerH);
        console.log($('.banner-wrap').width(), $('.banner-wrap').height()); // 1000 380
        ...
        */
        //Answer 3.
        var $bannerWrapW = $('.banner-wrap').width();
        var $bannerItem = $('.banner-item').length;
        console.log($bannerWrapW); // 1000
        console.log($bannerItem); // 5

        var Multiply = $bannerWrapW * $bannerItem;
        console.log(Multiply); // 5000
        
        $('.banner-container').width(Multiply);
        $('.banner-container').height('100%');
        console.log($('.banner-container').width()); // 5000
        console.log($('.banner-container').height()); //380
        ...
        */
        ...
        console.log($('.paddle-nav .arrow.prev').css('left')); // 18px
        ...
        */
        ...
        var $banneritemW = $('.banner-item').width();
        $bannerCon.css('transition', 'all .5s');
        $bannerCon.css('left', 0); // 첫 left 위치값 0으로 초기화


        console.log($banneritemW);
        function slideLeft(){
            _id--;
            $bannerCon.css('left', _id * $banneritemW * -1);
        }
        // slideLeft();
        ...
        */
        ...
        function paddleCheck() {
            ...
            else if(_id == $bannerItem - 1){ // $bannerItem는 3번에서 선언함. 
