(function($){
    $(document).ready(function(){
        ...
        */
        ...
        console.log($bannerW); // 1000
        console.log($bannerH); // 380
        
        $('.banner-wrap').css('width', $bannerW);
        $('.banner-wrap').css('height', $bannerH);
        console.log($('.banner-wrap').width(), $('.banner-wrap').height()); // 1000, 300
        ...
        */
        ...
        var i = $bannerWrapW * $bannerItem;
        console.log(i); // 5000

        $('.banner-container').width(i);
        ...
        */
        ...
        function slideLeft(){
            _id--;
            $bannerContainer.css('left', _id * $bannerItemW * -1);
        }
