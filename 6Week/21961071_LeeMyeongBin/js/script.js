(function($){
    $(document).ready(function(){
        ...
        */
        ...
        // 2
        // $('.banner-wrap').width($bannerW);
        // $('.banner-wrap').height($bannerH);
        // console.log($('.banner-wrap').width(), $('.banner-wrap').height()); // 1000, 380
        ...
        */
        ...
        // var $bannerWrapH = $('.banner-wrap').height();
        var $bannerItem = $('.banner-item').length;
        console.log($bannerItem); //5

        var sum = $bannerWrapW * $bannerItem;
        console.log(sum); // 5000

        $('.banner-container').width(sum);
        ...
        */
        ...
        // console.log($('.paddle-nav .arrow.next').css('right')); //18px
        ...
        */
        ...
        // console.log($('.dot-nav').css('bottom')); //20px
        ...
        */
        ...
        var _id = 0;
        var $bannerCtn = $('.banner-container');
        $bannerCtn.css({
        ...
        function slideLeft(){
            _id--;
            $bannerCtn.css('left', _id * $('.banner-item').width() * -1);
        }
        // slideLeft();
