(function($){
    $(document).ready(function(){
        ...
        */
        ...
        var bannerItemL = $(".banner-item").length;

        var wiWidth = bannerWrapW * bannerItemL;
        // alert(wiWidth);
        // $(".banner-container").css("width", )

        $(".banner-container").css("width", wiWidth);
        $(".banner-container").css("height", "100%");
        ...
        */
        ...
        function slideLeft() {
            _id--;
            bannerC.css("left", _id * bannerItemW * -1);
        }
        // slideLeft();
        ...
        */
        //Answer 11.
        var arrowP = $(".arrow.prev");
        var arrowN = $(".arrow.next");
        ...
        */
        //Answer 12.
        var dotNavS = $(".dot-nav span");
        function dotSelect() {
            if(dotNavS.hasClass("selected")){
                dotNavS.removeClass("selected");
            }
            dotNavS.eq(_id).addClass("selected");
        }
        ...
        */
        ...
        function paddleCheck() {
            ...
            else if(_id == bannerItemL - 1) {
                $(arrowN).addClass("disabled");
            }
            else {
