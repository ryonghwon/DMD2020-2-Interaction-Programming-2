(function($){
    $(document).ready(function(){
        ...
        */
        ...
        /* var $wrapbannerW = $('.banner-wrap').width();
        var $wrapbannerH = $('.banner-wrap').height();
        console.log($wrapbannerW, $wrapbannerH); */ // 1000, 510

        var $wrapbannerH = $('.banner-wrap');
        $wrapbannerH.height(380);
        /* console.log($wrapbannerH.height()); */ // 1000, 380
        ...
        */
        ...
        var $wrapbannerH = $('.banner-wrap').width();
        console.log($bannerI);
        console.log($wrapbannerH);
        var $bannerCon = $('.banner-container');
        $bannerCon.width($bannerI * $wrapbannerH);
        $bannerCon.height('100%');
        console.log($bannerCon.width()); //5000
        /*
        Quest 4.
        ...
        */
        ...
        console.log($bannerItem.width());
        $bannerItem.width(1000);
        ...
        */
        ...
        var _id = 0;
        $bannerI = $('.banner-item').width();

        function slideLeft(){
            _id--;
            $('.banner-container').css('left', $bannerI * _id);
        };
        ...
        */
        ...
        function slideRight(){
            _id++;
            $('.banner-container').css('right', $bannerI * _id);
        };
