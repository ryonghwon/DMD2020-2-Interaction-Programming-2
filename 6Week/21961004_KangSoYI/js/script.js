(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //console.log('width' + $bannerW);
        //console.log('height' + $bannerH);
        
        $('.banner-wrap').css('width', $bannerW);
        ...
        */
        //Answer 3.
        var $bannerW = $('.banner-wrap').width();
        //var $bannerI = $('.banner-item').length;
        var $bannerI = $('.banner-item')
        //var $bannerC = $('.banner-container').width();
        var $bannerC = $('.banner-container');

        //console.log($bannerW * $bannerI);
        $bannerC.width($bannerW * $bannerI.length);
        $bannerC.height('100%');
        //console.log($bannerC.width());
        //console.log($bannerC.height());
        ...
        */
        //Answer 4.
        $bannerI.css('float', 'left');
        //console.log($bannerI.css('float'));
        $bannerI.css('width', $bannerW);
        //console.log($bannerI.css('width'));
        $bannerI.css('height', '100%');
        //console.log($bannerI.css('height'));
        ...
        */
        ...
        //console.log($('.banner-item img').css('width'));
        ...
        */
        ...
        //console.log($('.paddle-nav .arrow.prev').css('left'));
        ...
        */
        ...
        //console.log($('.paddle-nav .arrow.next').css('right'));
        ...
        */
        ...
        //console.log($('.dot-nav').css('bottom'));
        ...
        */
        //Answer 9.
        var _id = 0; //이미지의 인덱스 0부터 4번
        var $bannerIW = $('.banner-item').width();

        function slideLeft() {
                //$bannerC.css('left', _id * -$bannerIW);
                //--_id;
                _id--;
                $bannerC.css('left', _id * $bannerIW * -1);
                //console.log(_id);
        }
        //slideLeft();
        ...
        */
        //Answer 10.
        function slideRight() {
                //$bannerC.css('right', _id * $bannerIW);
                _id++;
                $bannerC.css('left', _id * $bannerIW * -1);
                //console.log(_id);
        }
