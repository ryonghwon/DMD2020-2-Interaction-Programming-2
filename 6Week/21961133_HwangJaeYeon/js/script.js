(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 2.
        var $banW = $('.banner').width();
        var $banH = $('.banner').height();
        $('.banner-wrap').width($banW);
        $('.banner-wrap').height($banH);
        ...
        */
        //Answer 3.
        var $banItem = ('.banner-item').length * $banW;
        $('.banner-container').width($banItem);
        ...
        */
        //Answer 5.
        $('.banner-item').children().children('img').width('100%');
        ...
        */
        //Answer 12.
        function dotSelect(){
            $('.dot-nav ul li span').removeClass('selected');
            if(_id == 0){
        ...
        */
        ...
        function paddleCheck(){
            ...
            if(_id == $('.banner-item').length-1){
                $('.arrow.next').addClass('disabled');
            }
            if(_id == 0 && _id !== $('.banner-item').length-1){
