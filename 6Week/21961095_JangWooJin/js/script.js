(function ($) {
    $(document).ready(function () {
        ...
        */
        ...
        $('.banner-container').css('width', $('.banner-wrap').width() * $('.banner-item').length);
        ...
        */
        ...
        function slideLeft() {
            _id--;
            $('.banner-container').css('left', $('.banner-item').width() * -_id);
        }
        ...
        */
        ...
        function dotSelect() {
            if ($('.dot-nav span').hasClass('selected')) {
        ...
        */
        ...
        function paddleCheck() {
            ...
            } else if (_id == $('.banner-item').length - 1) {
