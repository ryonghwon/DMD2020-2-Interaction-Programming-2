(function($){
    $(document).ready(function(){
        ...
        */
        ...
        $(".banner-container").width($bannerItem.width() * $bannerItem.length);
        ...
        */
        //Answer 6.
        $(".paddle-nav .arrow.prev").css("left", 18 + "px");
        ...
        */
        //Answer 7.
        $(".paddle-nav .arrow.next").css("right", 18 + "px");
