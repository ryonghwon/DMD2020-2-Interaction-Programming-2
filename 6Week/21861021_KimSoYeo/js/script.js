(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 3.
        var $bannerCon = $bannerWidth * $(".banner-item").length;
        $('.banner-container').width($bannerCon);
        ...
        */
        ...
        $bannerItem.width($(".banner-wrap").width());
        ...
        */
        //Answer 6.
        var $paddleNavPre = $('.paddle-nav .arrow.prev');
        $paddleNavPre.css('left','18px');
        ...
        */
        //Answer 7.
        var $paddleNavNext = $('.paddle-nav .arrow.next');
        $paddleNavNext.css('right','18px');
        ...
        */
        //Answer 9.
        var _id = 0;
        var $itemW = $('.banner-item').width();

        function slideLeft(){
            _id--;
            $('.banner-container').css('right', $itemW * _id);
        }
        // slideLeft();
        ...
        */
        ...
        // console.log($('.dot-nav span'));

        function dotSelect(){
            $('.dot-nav span').removeClass('selected');
            $('.dot-nav span').eq(_id).addClass('selected');
        }
        ...
        */
        ...
        function paddleCheck(){
            ...
            if( _id == $bannerItem.length - 1 ){
                $('.arrow.next').addClass('disabled');
            }
            if( _id !== 0 && _id !== $bannerItem.length - 1){
