...
(function($){
    $(document).ready(function(){
        ...
        */
        ...
        var radioChildren = $radio_list.children();
        console.log(radioChildren.length);
        ...
        */
        ...
        var $typeParent = $(".type-2").parent();
        console.log($typeParent.index());
        ...
        */
        ...
        var $radio1 = $("input[type='radio']#radio-1");
        // console.log($radio1.value); value 값을 불러올수 없었음. undefinded
        // 아직 jQuery로 value 를 출력하는것을 배우지 않음.
        ...
        */
        ...
        // 아직 jQuery로 텍스트를 포함하는 것을 찾는 메서드를 배우지 않음.
        ...
        */
        //Answer 10.
        var $inputRadio2 = $('input[type="radio"]').not('#radio-2');
        $inputRadio2.parent().children('label').addClass("emphasis");
        ...
        */
        //Answer 11.
        var $liHasLast = $('li.sub-last').parents(".last");
        // console.log($liParent);
        $liHasLast.children("a").addClass("emphasis");
        $liHasLast.find('a').addClass('bold');
    });
})(jQuery);
