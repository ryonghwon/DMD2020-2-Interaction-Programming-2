...
(function($){
    $(document).ready(function(){
        ...
        */
        ...
        var $radio = $('div#radio-list');
        var radioLength = $radio.children()
        console.log(radioLength.length);
        ...
        */
        ...
        var $type2Parent = $('.type-2');
        var $type2Index = $type2Parent.parent();
        console.log($type2Index.index());
        ...
        */
        ...
        var $radio1 = $('#radio-1[input="value"]');
        console.log($radio1.find('input="value'));
        ...
        */
        //Answer 10.
        var $radioNotId = $('input:not(#radio-2)');
        var $radioNotIdParent =  $radioNotId.parent();
        $radioNotIdParent.children('label').addClass('emphasis');
        ...
        */
        //Answer 11.
        var $liSub = $('li.sub-last');
        var $liSubParent = $liSub.parents('.last');
        $liSubParent.children('a').addClass('emphasis');
        $liSubParent.find('a').addClass('bold');
