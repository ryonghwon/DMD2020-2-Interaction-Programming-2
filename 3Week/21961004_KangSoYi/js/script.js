...
(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //console.log($radioList.children);
        ...
        */
        ...
        //console.log($type2);
        //console.log($type2.parent);
        console.log($type2.parent().index());
        ...
        */
        //Answer 10.
        var $inputRadio = $('input[type="radio"]:not("#radio-2")').parent();
        //console.log($inputRadio);
        $inputRadio.children('label').addClass('emphasis');
        //console.log($inputRadio);
        ...
        */
        ...
        //console.log($subLast.children('a'));
        $subLast.find('a').addClass('bold');
        //console.log($subLast.find('a'));
