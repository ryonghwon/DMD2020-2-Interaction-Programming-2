...
(function ($) {
    $(document).ready(function () {
        ...
        */
        ...
        var hasType = $('.type-2').parent();
        console.log(hasType.index());
        ...
        */
        ...
        var value = $('#radio-1').val();
        console.log(value);
        var value2 = $('input[name=radio]').eq(0).val();
        console.log(value2);
        ...
        */
        ...
        // var menuSeven = $('a:contains("Menu 7")');
        ...
        */
        ...
        var notRadioTwo = $('input[type="radio"]').not('#radio-2');
        notRadioTwo.parent().children('label').addClass('emphasis');
        ...
        */
        ...
        var subLastP = $('li.sub-last').parents('.last');
        console.log(subLastP);
        subLastP.children('a').addClass('emphasis');
        subLastP.find('a').addClass('bold');
    });
})(jQuery);
