...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 2.
        var $aHasType = $('a.type-2');
        $aHasType.addClass('current');
        ...
        */
        //Answer 10.
        var $not2radio = $('input:not(#radio-2)').parent();
        // var $not2radio = $('input').not('#radio-2').parent();
        $not2radio.children('label').addClass('emphasis');
