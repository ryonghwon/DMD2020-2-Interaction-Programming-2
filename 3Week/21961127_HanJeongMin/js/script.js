...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 5.
        var $lirolo = $('li[data-role="link"]');
        $lirolo.addClass('role');
        ...
        */
        ...
        console.log($type2.parent.length); */
        var $type2 = $('.type-2').parent();
        ...
        */
        //Answer 10.
        var $emRadio = $('input[type="radio"]').not('#radio-2').parent();
        $emRadio.children('label').addClass("emphasis");
        ...
        */
        ...
        /* $sublast.find('a').children('a').addClass('emphasis'); */
