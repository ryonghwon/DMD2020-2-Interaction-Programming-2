...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 5.
        var $li_link = $('li[data-role=link]');
        $li_link.addClass("role");
        ...
        */
        ...
        var $child_radioList = $('#radio-list').children();
        console.log($child_radioList.length);
        ...
        */
        ...
        var $parent_type2 = $('.type-2').parent();
        console.log($parent_type2.index());
        ...
        */
        ...
        var $id_radio1 = $('input#radio-1[type=radio]');
        // console.log($id_radio1.value); //undifined
        console.log($id_radio1.val());
        ...
        */
        ...
        // 잘 모르겠어서 검색해서 나온 contains라는 것을 사용했습니다.
        var $a_Menu7 = $('a:contains("Menu 7")');
        console.log($a_Menu7);
        ...
        */
        //Answer 10.
        var $no_radio2 = $('input:not(#radio-2)').parent();
        $no_radio2.children('label').addClass('emphasis');
        ...
        */
        //Answer 11.
        var $li_SubLast = $('li.sub-last').parents('.last');
        $li_SubLast.children('a').addClass('emphasis');
        $li_SubLast.find('a').addClass('bold');
