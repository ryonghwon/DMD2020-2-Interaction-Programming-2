...
(function($){
    $(document).ready(function(){
        ...
        */
        ...
        //var $input = $('input:not(#radio-2').parents();
        var $input = $('input:not(#radio-2').parent();
        //console.log($input);
        ...
        */
        ...
        //var $subLast = $('li.sub-last').parents();
        //var $subLast = $('li.sub-last').parent();
        var $subLast = $('li.sub-last').parents('.last');
        console.log($subLast);
        //$subLast('a').addClass('emphasis');
        $subLast.children('a').addClass('emphasis');
        //$subLast.children('a').addClass('bold');
