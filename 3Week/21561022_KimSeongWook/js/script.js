...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 4.
        var $_aSpan = $('a:has(span)');
        $_aSpan.addClass('inner');
        ...
        */
        ...
        var $_radioList = $('#radio-list');
        console.log($_radioList.children.length);
