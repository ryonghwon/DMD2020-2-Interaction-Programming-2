...
(function($){
    $(document).ready(function(){
        ...
        */
        ...
        var radioListLength = $("#radio-list").children().length;
        console.log(radioListLength);
        ...
        */
        ...
        var typeIndex = $(".type-2").parent();
        var IndexV = $(typeIndex).index();
        console.log(IndexV);
        ...
        */
        ...
        var vW1 = $("#radio-1").val();
        console.log(vW1);
        var vW2 = $("#radio-1[name=radio]").val();
        console.log(vW2);
        ...
        */
        ...
        var sW1 = $("a:contains('Menu 7')");
        console.log(sW1);
        // var sW2 = $("a").text("Menu 7");
        // console.log(sW2);
        ...
        */
        //Answer 10.
        var inputRadioParent = $("input:not('#radio-2')").parent();
        console.log(inputRadioParent);
        $(inputRadioParent).children("label").addClass("emphasis");
        ...
        */
        //Answer 11.
        var sLastClass = $("li.sub-last");
        console.log(sLastClass);
        var pLastClass = $(sLastClass).parents(".last");
        console.log(pLastClass);
        $(pLastClass).children("a").addClass("emphasis");
        $(pLastClass).find("a").addClass("bold");
    });
})(jQuery);